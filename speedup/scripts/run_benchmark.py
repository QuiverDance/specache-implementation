...
def build_qasper_prompt(item, tokenizer, max_length):
    ...
    return prompt_template.format(context=truncated_context, question=item['input'])
...
def run_benchmark(config):
    ...
    max_input_len = min(mistral_config.max_seq_len - benchmark_args['max_new_tokens'], PRACTICAL_MAX_LEN)
